package com.backend.design.pattern.creational.builderPattern;

/**
 * Most Common Way to implement builder pattern is to have Builder class as innner class because : - You might have
 ...
 * 3. Now since constructor is private we will need inner class to access that. - Which will have same inputs what we
 * have in class. But without getters.
 */
public class Burger {
