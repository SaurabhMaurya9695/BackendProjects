...
public class DiagonalOrderAntiClockWiseBT {

    public ArrayList<ArrayList<Integer>> ans = new ArrayList<>();
    public ArrayList<Integer> temp = new ArrayList<>();

    public DiagonalOrderAntiClockWiseBT(Node node) {
        temp = diagonalAntiClockWise(node);
    }

    public ArrayList<Integer> diagonalAntiClockWise(Node root) {
